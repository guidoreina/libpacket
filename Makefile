...
OBJS = util/hash.o string/buffer.o memory/file.o fs/file.o pcap/reader.o \
       pcap/live_reader.o pcap/ip/analyzer.o pcap/ip/live_analyzer.o \
       pcap/ip/tcp/connection/analyzer.o net/ip/address_list.o \
       ...
       net/ip/services.o net/ip/statistics.o net/ip/statistics_lite.o
